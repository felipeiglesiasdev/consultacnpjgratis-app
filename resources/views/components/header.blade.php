    ...
    <div class="container mx-auto px-6 md:px-10 xl:px-16">
        <div class="flex items-center justify-between gap-4 py-3 md:py-4">
            ...
            <a href="{{ url('/') }}" class="flex items-center gap-2 md:gap-3">
                <div class="flex h-9 w-9 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-400 to-amber-500 shadow-[0_0_25px_rgba(251,191,36,0.4)]">
                    <span class="text-xs font-black text-black tracking-tight">
                        CNPJ
                    </span>
                </div>
                <div class="flex flex-col">
                    <span class="text-sm md:text-base font-bold text-white leading-tight">
                        Consultar CNPJ Grátis
                    </span>
                    <span class="text-[10px] md:text-[11px] uppercase tracking-[0.22em] text-amber-200/80">
            ...
            <nav class="hidden lg:flex items-center gap-6 text-sm">
                <a href="{{ url('/') }}"
                   class="inline-flex items-center gap-1 text-gray-200 hover:text-amber-300 transition">
                    <i class="bi bi-search text-xs"></i>
                    Consulta CNPJ
                </a>

                <a href="{{ route('empresas.index') }}"
                   class="inline-flex items-center gap-1 text-gray-300 hover:text-amber-300 transition">
            ...
            <div class="hidden md:flex items-center gap-2">
                ...
                >
                    ...
                    <button
                        type="submit"
                        class="hidden sm:inline-flex items-center rounded-full bg-amber-400 px-3 py-1 text-[11px] font-semibold text-black hover:bg-amber-300 transition"
                    >
                        Consultar
                    </button>
                </form>
    ...
    <div id="mobile-nav" class="lg:hidden hidden border-t border-white/10 bg-[#050509]">
        <div class="container mx-auto px-6 md:px-10 xl:px-16 py-3 space-y-3 text-sm">
            ...
            >
                ...
                <button
                    type="submit"
                    class="inline-flex items-center rounded-full bg-amber-400 px-3 py-1 text-[11px] font-semibold text-black hover:bg-amber-300 transition"
                >
                    Consultar
                </button>
            </form>
